...
use App\Form\ResetPassswordFormType;
use App\Form\ResetPassswordRequestFormType;
...
class SecurityController extends AbstractController
{
    ...
    #[Route(path: '/oubli-pass', name: 'app_forgotte_password')]
    ...
    {
        $form = $this->createForm(ResetPassswordRequestFormType::class);
    ...
    public function resetPass(string $token, Request $request, UsersRepository $usersRepository, EntityManagerInterface $entityManager, UserPasswordHasherInterface $passwordHasher): Response
    {
        ...
        if($user){
            $form = $this->createForm(ResetPassswordFormType::class);
